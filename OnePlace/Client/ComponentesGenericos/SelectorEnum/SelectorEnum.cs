...
namespace OnePlace.Client.ComponentesGenericos.SelectorEnum
{
    ...
    public sealed class SelectorEnum<TEnum> : InputBase<TEnum>
    {
        ...
        protected override void BuildRenderTree(RenderTreeBuilder builder)
        {
            ...
            foreach (TEnum value in System.Enum.GetValues(enumType))
            {
