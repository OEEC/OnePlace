...
using OnePlace.Client.ComponentesGenericos.Interface;
using System;
...
using OnePlace.Client.ComponentesGenericos.Extensions;
using System.Linq.Expressions;
using System.Reflection;
using static System.String;

namespace OnePlace.Client.ComponentesGenericos.Base
{
    public abstract class SimFormComponent<T, U> : SimComponentBase, IFormComponent, IDisposable
    {
        private Utilities.BindingConverters.Converter<T, U> _converter;

        protected SimFormComponent(Utilities.BindingConverters.Converter<T, U> converter)
        {
        ...
        [Parameter]
        public Utilities.BindingConverters.Converter<T, U> Converter
        {
            get => _converter;
            set => SetConverter(value);
        }

        protected virtual bool SetConverter(Utilities.BindingConverters.Converter<T, U> value)
        {
